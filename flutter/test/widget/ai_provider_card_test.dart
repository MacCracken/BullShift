...
void main() {
  group('AIProviderCard Widget Tests', () {
    ...
    testWidgets('shows configured status when configured',
    ...
    testWidgets('shows not configured status when not configured',
        (WidgetTester tester) async {
      final aiProvider = {
        'name': 'Test Provider',
        'type': 'OpenAI',
    ...
    testWidgets('shows configure button when not configured',
        (WidgetTester tester) async {
      final aiProvider = {
        'name': 'Test Provider',
        'type': 'OpenAI',
    ...
    testWidgets('shows test and edit buttons when configured',
        (WidgetTester tester) async {
      final aiProvider = {
        'name': 'Test Provider',
        'type': 'OpenAI',
    ...
    testWidgets('displays last used time when available',
        (WidgetTester tester) async {
      final aiProvider = {
        'name': 'Test Provider',
        'type': 'OpenAI',
