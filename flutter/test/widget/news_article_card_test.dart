...
void main() {
  group('NewsArticleCard Widget Tests', () {
    ...
    testWidgets('displays article title', (WidgetTester tester) async {
      ...
      expect(find.text('Apple Stock Surges on Strong Earnings Report'),
          findsOneWidget);
    });

    testWidgets('displays source and formatted timestamp',
    ...
    testWidgets('displays sentiment badge with correct color',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(sampleArticle));
    ...
    testWidgets('has Read More and Analysis buttons',
        (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget(sampleArticle));
    ...
    testWidgets('handles bearish sentiment correctly',
        (WidgetTester tester) async {
    ...
    testWidgets('handles neutral sentiment correctly',
        (WidgetTester tester) async {
    ...
    testWidgets('formats timestamp correctly for different time ranges',
        (WidgetTester tester) async {
      // Just now
      final justNow = {
        ...sampleArticle,
