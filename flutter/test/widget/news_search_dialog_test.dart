...
void main() {
  group('NewsSearchDialog Widget Tests', () {
    ...
    testWidgets('has symbols field', (WidgetTester tester) async {
      ...
      expect(find.widgetWithText(TextField, 'Symbols (comma-separated)'), findsOneWidget);
    });
    ...
    testWidgets('accepts text input in keywords field', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
      await tester.tap(find.text('Show Dialog'));
      await tester.pumpAndSettle();
    ...
    testWidgets('accepts text input in symbols field', (WidgetTester tester) async {
      await tester.pumpWidget(createTestWidget());
      await tester.tap(find.text('Show Dialog'));
      await tester.pumpAndSettle();
