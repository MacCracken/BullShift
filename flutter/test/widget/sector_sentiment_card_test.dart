...
void main() {
  group('SectorSentimentCard Widget Tests', () {
    ...
    testWidgets('shows progress bar for sentiment', (WidgetTester tester) async {
      final sector = {
        'name': 'Energy',
        'sentiment': 0.50,
      };
    ...
    testWidgets('shows green for positive sentiment', (WidgetTester tester) async {
      final sector = {
        'name': 'Tech',
        'sentiment': 0.80,
      };
    ...
    testWidgets('shows red for negative sentiment', (WidgetTester tester) async {
      final sector = {
        'name': 'Utilities',
        'sentiment': -0.40,
      };
    ...
    testWidgets('shows grey for neutral sentiment', (WidgetTester tester) async {
      final sector = {
        'name': 'Materials',
        'sentiment': 0.20,
      };
    ...
    testWidgets('displays sentiment bar aligned left for positive', (WidgetTester tester) async {
      final sector = {
        'name': 'Finance',
        'sentiment': 0.70,
      };
